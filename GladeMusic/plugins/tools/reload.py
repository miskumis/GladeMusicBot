...
from GladeMusic.utils.database import get_authuser_names, get_cmode
from GladeMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from GladeMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Glade.stop_stream(message.chat.id)
    except:
        pass
