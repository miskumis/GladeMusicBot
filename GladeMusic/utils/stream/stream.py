...
import config
from GladeMusic import Carbon, YouTube, app
...
from GladeMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from GladeMusic.utils.inline.playlist import close_markup
from GladeMusic.utils.pastebin import Gladebin
from GladeMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Glade.force_stop_stream(chat_id)
